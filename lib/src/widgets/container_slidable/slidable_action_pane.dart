          ...
          builder: (context, child) {
            return FractionallySizedBox(
              ...
              child: Flex(
                ...
                children: data.buildActions(context).map((a) => Expanded(child: a)).toList(),
              ),
            );
          },
        ),
      ...
      child: Positioned.fill(
        child: Stack(
          ...
          children: List.generate(
            data.actionCount,
            (index) {
              int displayIndex = data.showActions ? data.actionCount - index - 1 : index;
              return SlideTransition(
                position: animations[index],
                child: FractionallySizedBox(
                  alignment: data.alignment,
                  widthFactor: data.directionIsXAxis ? data.actionExtentRatio : null,
                  heightFactor: data.directionIsXAxis ? null : data.actionExtentRatio,
