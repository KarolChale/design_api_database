                ...
                child: Stack(
                  children: List.generate(data.actionCount, (index) {
                    ...
                    return data.createFractionallyAlignedSizedBox(
                      positionFactor: data.actionExtentRatio * (data.actionCount - index - 1),
                      extentFactor: extentAnimations[index].value,
                      child: data.actionDelegate.build(context, displayIndex, data.actionsMoveAnimation, data.renderingMode),
                    );
                  }),
                ),
              );
