...
import 'package:design_api_database/src/widgets/calendar/date_utils.dart';
...
class CalendarStripState extends State<CalendarStrip> with TickerProviderStateMixin {
  ...
  runPresetsAndExceptions(selectedDate, startDate, endDate) {
    ...
    } else if (selectedDate != null && (!isDateAfter(selectedDate, startDate) || !isDateBefore(selectedDate, endDate))) {
